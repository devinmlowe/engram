...
You should see 12 tools. The five core ones are `recall`, `remember`, `show`, `explore`, and `reflect`; the rest are the session and file-analysis tools listed in [api-reference.md](./api-reference.md).
