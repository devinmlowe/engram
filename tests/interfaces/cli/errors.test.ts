...
describe("engram CLI uncaught command errors (#37)", () => {
  it.skipIf(!built)("explore of an unknown entity prints one line to stderr and exits 1, with no stack trace", () => {
  ...
  it.skipIf(!built)("an error before the database opens is reported the same way", () => {
