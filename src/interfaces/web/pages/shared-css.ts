...
export function sharedPanelCss(): string {
  ...
  #settings-toggle {
    ...
    background: rgba(39,46,51,0.85); border: 1px solid #374145;
  ...
  #settings-panel {
    ...
    background: rgba(30,35,38,0.95); border-left: 1px solid #374145;
  ...
  .panel-header {
    ...
    padding: 16px 20px 12px; border-bottom: 1px solid #272e33;
  }
  ...
  .section { border-bottom: 1px solid #272e33; }
  .section-header {
    display: flex; align-items: center; gap: 8px;
    padding: 12px 20px; cursor: pointer; user-select: none;
    transition: background 0.1s;
  }
  .section-header:hover { background: rgba(55,65,69,0.3); }
  ...
  .ctrl-row input[type=text] {
    width: 100%; background: #272e33; border: 1px solid #374145;
  ...
  .switch {
    width: 36px; height: 20px; background: #374145; border-radius: 10px;
  ...
  .pill {
    background: #272e33; border: 1px solid #374145; border-radius: 14px;
  ...
  .preset-btn {
    flex: 1; background: #272e33; border: 1px solid #374145; border-radius: 8px;
    padding: 6px 0; color: #9da9a0; font-size: 11px; font-weight: 600;
    cursor: pointer; transition: all 0.15s; text-align: center;
  }
  .preset-btn:hover { border-color: #7fbbb3; color: #d3c6aa; }
  .preset-btn.active { background: #374145; color: #7fbbb3; border-color: #7fbbb3; }
  ...
  #animate-btn:hover { background: #374145; border-color: #7fbbb3; }
  ...
  #anim-progress {
    ...
    background: rgba(30,35,38,0.9); border: 1px solid #374145;
  ...
  #anim-bar-wrap {
    width: 120px; height: 3px; background: #272e33; border-radius: 2px; overflow: hidden;
  }
  #anim-bar {
