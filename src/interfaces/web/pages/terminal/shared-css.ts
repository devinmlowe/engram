...
export function terminalSharedCss(): string {
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  #view-tabs {
    ...
    display: flex; gap: 0;
    background: #191d20;
    border-bottom: 2px solid #374145;
    padding: 0;
  }
  #view-tabs a {
    padding: 6px 16px;
  ...
  #view-tabs a:hover { color: #d3c6aa; background: #272e33; }
  #view-tabs a.active { color: #7fbbb3; background: #272e33; border-bottom: 2px solid #7fbbb3; }

  /* ─── Stats bar ─── */
  #stats-bar {
    position: fixed; bottom: 0; left: 0; right: 0; z-index: 50;
    font-size: 13px; color: #9da9a0;
    background: #191d20; border-top: 1px solid #374145;
    padding: 4px 12px;
    font-family: monospace;
  }
  ...
  #info-panel .close-btn {
    float: right; background: none; border: 1px solid #374145;
